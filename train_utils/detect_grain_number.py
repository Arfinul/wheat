...
if __name__ == "__main__":
    ...
    oneGrain = 'model_segmentation/boundry_1_30.pkl'
    moreGrain = 'model_segmentation/boundry_2_30.pkl'
    ...
    model_file = 'model_segmentation/weights_' + str(x_train[0].shape[0]) + "_" + str(x_train[0].shape[1]) + '_.h5'
