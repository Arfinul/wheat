from segmentation.Area import areaThreshold_by_top
from segmentation.threshold import otsu_threshold
from segmentation._8connected import get_8connected
from segmentation.util import *
import warnings
from eclipse_test import elliptic_fourier_descriptors, efd
...
def L2_segmentation_2(iimg , T, index):
    ...
    mask = get_8connected(thresh=thresh2, mcount=index)
